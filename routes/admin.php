...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('/marriage_support','MemberController@marriage_support')->name('marriage.support.admin');
    ...
    Route::get('/profile-payment', [PublicProfileController::class, 'showPaymentOrProfile'])->name('profile.paymentOrProfile');
