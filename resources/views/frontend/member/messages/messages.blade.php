            ...
            <span class="avatar avatar-sm mr-3 flex-shrink-0">
              ...
              @endphp
                ...
                @if ($chat_thread->$user_to_show->photo != null)
                    <img src="{{ uploaded_asset($chat_thread->$user_to_show->photo) }}" alt="no.1marry">
                @else
        ...
        <form id="send-mesaage">
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <button class="btn btn-circle btn-icon chat-attachment" type="button" style="height: 100%;">
                        <i class="las la-paperclip"></i>
                    </button>
                    <button class="btn btn-primary btn-circle btn-icon" onclick="send_reply()" type="button" style="height: 100%;">
                ...
                <div class="text-center">
                    ...
                    <div class="text-center mb-3 px-3 mt-3">
                        <a
                            ...
                            @endif
                            class="btn1  btn-soft-primary p-3 mt-5">{{ translate('View Full Profile') }}
                        </a>
                    </div>
                </div>
            </div>
