                                    ...
                                    <div class="row gutters-10">
                                            ...
                                            <div class="col-6 col-md-3">
                                                <label class="aiz-megabox d-block mb-3">
                                                    ...
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/payment_method/paypal.png')}}" alt="Payment Gateway" class="img-fluid mb-2">
                                        ...
                                        @if(get_setting('stripe_payment_activation') == 1)
                                            <div class="col-6 col-md-3">
                                                <label class="aiz-megabox d-block mb-3">
                                                    ...
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/payment_method/stripe.png')}}" alt="no.1marry" class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                        ...
                                        <div class="col-6 col-md-3">
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block p-3 aiz-megabox-elem">
                                                    <img src="{{ static_asset('assets/img/payment_method/instamojo.png')}}" class="img-fluid mb-2" alt="no.1marry">
                                                    <span class="d-block text-center">
                                        ...
                                        <div class="col-6 col-md-3">
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block p-3 aiz-megabox-elem">
                                                    <img src="{{ static_asset('assets/img/payment_method/rozarpay.png')}}" alt="Razorpay" class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                        ...
                                        @if(get_setting('manual_payment_1_activation') == 1)
                                            <div class="col-6 col-md-3">
                                                <label class="aiz-megabox d-block mb-3">
                                                    ...
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ uploaded_asset(get_setting('manual_payment_1_image')) }}" alt="no.1marry" class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                        ...
                                        @if(get_setting('manual_payment_2_activation') == 1)
                                            <div class="col-6 col-md-3">
                                                <label class="aiz-megabox d-block mb-3">
                                                    ...
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ uploaded_asset(get_setting('manual_payment_2_image')) }}" alt="no.1marry" class="img-fluid mb-2">
                                                        <span class="d-block text-center">
