        ...
        <div class="row">
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        <div class="d-flex">
                            <h1 class="active_member fw-600 mb-3 text-body">{{ translate("All Active Members") }}</h1>
                            <div class="d-xl-none ml-auto mb-1 ml-xl-3 mr-0 align-self-end" id="search">
                                <button type="button" class="btn btn-icon p-0" data-toggle="class-toggle" data-target=".aiz-filter-sidebar">
                                   <span class="search-text"><i class="la la-search la-x"></i>Search</span> 
                                </button>
                            </div>
                        </div>
                        <div class="mb-5">
                                ...
                                <div class="row no-gutters border border-gray-300 rounded hov-shadow-md mb-4 has-transition position-relative" id="block_id_{{ $user->id }}">
                                    ...
                                    <div class="col-md position-static d-flex align-items-center">
                                        <span class="absolute-top-right px-4 py-3">
                                            ...
                                            <span class="badge badge-inline badge-info" id="badge-profile">{{ translate('Free') }}</span>
                                            @elseif($user->membership == 2)
                                            <span class="badge badge-inline badge-success" id="badge-profile">{{ translate('Preminum') }}</span>
                                            @endif
                                        </span>
                                        <div class="px-md-4 p-3 flex-grow-1">
                                            ...
                                            <div class="row gutters-5 text-center">
                                                <div class="col" style="background:#55c2da; border-radius:5px; padding:5px;">
                                                    <a 
                                                        @if(get_setting('full_profile_show_according_to_membership') == 1 && Auth::user()->membership == 1)
                                                            href="javascript:void(0);" onclick="package_update_alert()"
                                                        @else
                                                        ...
                                                        <span class="d-block fs-10 opacity-60" style="color:#fff; font-weight:800">{{ translate('Full Profile') }}</span>
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    @php
