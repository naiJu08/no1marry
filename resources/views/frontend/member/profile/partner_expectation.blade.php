        ...
        <form action="{{ route('partner_expectations.update', $member->id) }}" method="POST">
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <input type="number" name="partner_height" value="{{ !empty($member->partner_expectations->height) ? $member->partner_expectations->height : "" }}" step="any"  placeholder="{{ translate('Height') }}" class="form-control profile-input" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="partner_weight" value="{{ !empty($member->partner_expectations->weight) ? $member->partner_expectations->weight : "" }}" step="any" class="form-control profile-input" placeholder="{{translate('Weight')}}" required>
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <div class="profile-select-wrapper">
                        <select class="form-control profile-input profile-select" name="partner_marital_status" data-live-search="true" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="profile-select-wrapper">
                        <select class="form-control profile-input profile-select" name="partner_children_acceptable" required>
                            <option value="">{{ translate('Choose One') }}</option>
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <div class="profile-select-wrapper">
                        <select class="form-control profile-input profile-select" name="partner_religion_id" id="partner_religion_id" data-live-search="true" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="profile-select-wrapper">
                        <select class="form-control profile-input profile-select" name="partner_caste_id" id="partner_caste_id" data-live-search="true">
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <div class="profile-select-wrapper">
                        <select class="form-control profile-input profile-select" name="partner_sub_caste_id" id="partner_sub_caste_id" data-live-search="true">
                ...
                <div class="col-md-6">
                    ...
                    <div class="profile-select-wrapper">
                        <select class="form-control profile-input profile-select" name="language_id" data-live-search="true" required>
                            <option value="">{{translate('Select One')}}</option>
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <input type="text" name="pertner_education" value="{{ !empty($member->partner_expectations->education) ? $member->partner_expectations->education : "" }}" class="form-control profile-input" placeholder="{{translate('Education')}}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="partner_profession" value="{{ !empty($member->partner_expectations->profession) ? $member->partner_expectations->profession : "" }}" class="form-control profile-input" placeholder="{{translate('Profession')}}">
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <div class="profile-select-wrapper">
                        <select class="form-control profile-input profile-select" name="partner_country_id" id="partner_country_id" data-live-search="true" required>
                            <option value="">{{translate('Select One')}}</option>
                ...
                <div class="col-md-6">
                    ...
                    <div class="profile-select-wrapper">
                        <select class="form-control profile-input profile-select" name="partner_state_id" id="partner_state_id" data-live-search="true">
                ...
                <div class="col-md-6">
                    ...
                    <div class="profile-select-wrapper">
                        <select class="form-control profile-input profile-select" name="residence_country_id" data-live-search="true" required>
                            @foreach ($countries as $country)
