        ...
        <div class="card-body">
          <form action="{{ route('member.update_picture_privacy', Auth::user()->id) }}" method="POST">
              ...
              <div class="form-group mb-3">
                  ...
                  <select class="form-control" data-live-search="true" name="profile_picture_privacy" required>
              ...
              {{-- <div class="form-group mb-6">
                  ...
                  <select class="form-control" data-live-search="true" name="gallery_image_privacy" required>
