...
<style>
  ...
  .timeline .step{flex:1 1 200px;position:relative;padding-top:12px}
  ...
  .timeline .step:after{content:'';position:absolute;top:20px;left:60px;right:0;height:2px;background:linear-gradient(90deg, var(--brand), transparent)}
...
<body>
      ...
      <div class="row align-items-center g-4">
        <div class="col-lg-7 text-white" data-aos="fade-right">
          ...
          <div class="d-flex gap-4 mt-4 flex-wrap">
            ...
            <div><span class="h4 fw-bold">100%</span><div>Verified Profiles</div></div>
  ...
  <footer class="py-4 border-top">
    <div class="container d-flex flex-wrap justify-content-between align-items-center">
      <p class="mb-0">© {{ date('Y') }} No1Marry. All rights reserved.</p>
