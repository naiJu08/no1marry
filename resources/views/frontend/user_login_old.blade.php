          ...
          <div class="row g-0">
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <div class="text-center">
                  <img src="/public/assets/image-removebg-preview.png"
                ...
                <form action="{{ route('login') }}" method="POST" class="mt-3 login" autocomplete="nope">
                  ...
                  <div class="d-flex align-items-center justify-content-center pb-4">
                    ...
                    <button type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-danger"
                        onclick="window.location.href='https://no1marry.com/'">
                        Create new
                    </button>
            ...
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
              <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                ...
                <h4 class="mb-2">No1Marry: Unlimited Matches, One Simple Subscription<p class="card-price">
                    <!--<s> ₹99 </s> -->
                    &nbsp; ₹249 for 45 Days</p></h4>
...
<p> Why pay per contact when you can connect without limits? With No1Marry, a single subscription gives you access to unlimited contact details — no extra fees, no surprises.
</p>
<p>
‣ ₹249 for 45 Days
