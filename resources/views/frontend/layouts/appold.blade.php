...
.fa-bars {
    ...
    #view,#inbox-view,#mobile-inbox-view
    {
    display:none;
   
    }
    .nav-col2  #usermenu-nav {
    display: flex;
    flex-direction: column;
    display:none;
}
...
{
    display: none ;
    background:#18bdff !important;
        box-shadow: -1px -2px 10px 0px  !important;
}
.mobilebrand-logo
{
  width: 100%;
...
<body>
  ...
  <header id="header" style="background-color:#e91a1a;">
    <nav id="nav-left">
        <div class="nav-brand-col">
            <a>
                <img src="{{ static_asset('assets/assets_1/img/logo.jpg') }}"  class="brand-logo">
            </a>
        </div>
        ...
        <div class="nav-col">
            <ul>
                <li>
                                <a  href="{{ route('dashboard') }}"><span class="mx-2"><i
                                    class="fa-solid fa-house"></i></span>Home </a>
                </li>
                 <li>
                                <a  href="{{ route('member.listing') }}"><span class="mx-2"><i
                                    class="ri-user-search-fill"></i></span>Active Members</a>
                </li>
                <li>
                                <a  href="{{ route('packages') }}"><span class="mx-2"><i
                                    class="fa-solid fa-user-shield"></i></span>Upgrade to Premium</a>
                </li>
                <li>
                                <a  href="{{ route('matches') }}"><span class="mx-2"><i
                                    class="fa-solid fa-users"></i></span>Matches</a>
                </li>
            </ul>
        </div>
        <div class="nav-col2">
            <ul>
                <li class=" dropdown"  id="notification" >
                    @php
                                ...
                                $unseen_notification = \App\Models\Notification::where('notifiable_id',Auth()->user()->id)->where('read_at',null)->get();
                                @endphp
                                 
                        <a type="button" >
                          <span class="mx-2"><i class="fa-2x fa-solid  fa-bell"></i>
                          @if($unseen_notification->count() > 0)
                          <span class="badge badge-danger" id="dot"><span id="dot-value"></span>
                          @endif
                          </span>
                         </a>
                       </a>
                       
                         <ul class="dropdown-menu viewer-menu" id="view" style="min-width: 20rem;padding: 0.5rem 0.5rem;">
                                
                                @if($unseen_notification->count() > 0)
                                        @foreach ($unseen_notification as $key => $notification)
                                            @php
                                                $check = 'done';
                                            ...
                                            <li class="nav-item"><a href="{{ route('notification_view', $notification->id) }}" class="media text-inherit" style="justify-content: center;
                                                align-items: center;">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <small class="text-muted" style="font-size: .675em;">
                                                        {{ $notify_data->message }}
                                                    </small>
                                                </div>
                                            </a>
                                    ...
                                    @endif
                                    <div class="border-top" style="text-align: -webkit-center;">
                                        <a href="{{ route('frontend.notifications') }}"
                                            class="btn text-reset btn-block w-100">{{ translate('View All Notifications') }}</a>
                                    </div>
                                </ul>
                      </li>
                      <li class=" dropdown" id="inbox">
                          @php
                        ...
                        <a type="button" >
                          <span class="mx-2"><i class="fa fa-2x fa-solid fa-envelope"></i>
                         ...
                         <ul class="dropdown-menu viewer-menu" id="inbox-view" style="min-width: 20rem;padding: 0.5rem 0.5rem;">
                                    
                                    @foreach($unseen_chat_threads as $key => $chat_thread_id)
                                        @php
                                        ...
                                        @if ($chat != null)
                                        <li class="nav-item"><a href="{{ route('all.messages') }}" class="media text-inherit" style="justify-content: center;
                                            align-items: center;">
                                            <span class="avatar avatar-sm mr-3">
                                        ...
                                        @endforeach
                                    <div class="border-top" style="text-align: -webkit-center;">
                                        <a href="{{ route('all.messages') }}"class="btn text-reset btn-block w-100">{{ translate('View All Messages') }}</a>
                                    </div>
                      ...
                      <li class=" dropdown" id="user_id">
                           <a  type="button" data-toggle="dropdown" id="usermenu">
                          <b class="mx-2 font-italic d-sm-none d-lg-inline d-none">Hi {{Auth::user()->first_name}} !</b>
                          <img src="@if(Auth::user()->photo != "") {{ uploaded_asset(Auth::user()->photo) }} @else {{ static_asset('assets/img/avatar-place.png') }} @endif" id="user-icon">
                          <span class="caret"></span></a>
                       <ul class="dropdown-menu"  id="usermenu-nav" style>
                            <li class="nav-item user_text"><a class="nav-link" href=""><b class="mx-2 font-italic d-lg-none">Hi {{Auth::user()->first_name}} !</b></a> </li>
                          {{-- <li class="dropdown-submenu" id="test">
                            <a class=" nav-link test" href="#" ><span class="mx-2"> Account Setting</span> <span
                                class="caret"></span></a>
                            <ul class="dropdown-menu" id="test-nav">
                            
                              <li class="nav-item"><a class="nav-link" href="{{ route('member.picture_privacy') }}">Privacy Settings</a></li>
                              <li class="nav-item"><a class="nav-link" href="{{ route('member.change_password') }}">Change Password</a></li>
            
                            </ul>
                          </li>
            
                          <li class="dropdown-submenu" id="test2">
                            <a class="test nav-link" href="#"><span class="mx-2">Settings</span> <span class="caret"></span></a>
                            <ul class="dropdown-menu" id="test-nav2">
                              <li class="nav-item"><a class="nav-link" href="#">Hide Profile</a></li>
                              <li class="nav-item"><a class="nav-link" href="#">Delete Profile</a></li>
            
                            </ul>
                          </li> --}}
                          <li class="nav-item"><a class="nav-link" href="{{ route('member.picture_privacy') }}"><span class="mx-2">Privacy Settings</span></a></li>
                          <li class="nav-item"><a class="nav-link" href="{{ route('member.change_password') }}"><span class="mx-2">Reset Password</span></a></li>
                          <li class="nav-item">
                            <a href="javascript:void(0);" class="nav-link" onclick="account_deactivation()">
                                @if(Auth::user()->deactivated == 0 )
                                    <span class="mx-2">{{ translate('Delete Account') }}</span>
                                @else
                                    <span class="mx-2">{{ translate('Enable Account') }}</span>
                                @endif
                            </a>
                        </li>
                          <!--<li class="nav-item"><a class="nav-link" href="#"><span class="mx-2">Help & Support</span></a></li>-->
                          <li class="nav-item"><a class="nav-link" href="{{ route('logout') }}"><span class="mx-2">Logout</span></a></li>
                        </ul>
                      </li>
...
<header id="mobile">
  <nav id="mobile-left">
        <div class="mobile-brand-col">
            <a>
               
                <img src="{{ static_asset('assets/assets_1/img/logo.jpg') }}" class="mobilebrand-logo">
            </a>
        </div>
        
        <div class="mobile-col2">
            <ul>
                <li><a><span>
                  <i class="fa-2x fa-solid  fa-home text-white" style="color:#ffff"></i>
               </span>
               <span>
                <i class="bi bi-x-circle-fill fa-2x text-white" style="color:#ffff"></i>
               </span></a>
               </li>
               <li class=" dropdown"  id="mobile-notification">
                    @php
                                $notifications = \App\Models\Notification::latest()->where('notifiable_id',Auth()->user()->id)->take(10)->get();
                                $unseen_notification = \App\Models\Notification::where('notifiable_id',Auth()->user()->id)->where('read_at',null)->get();
                                @endphp
                        <a>
<span class="mx-2"><i class="fa-2x fa-solid  fa-bell text-white"></i>
                          @if($unseen_notification->count() > 0)
                          <span class="badge badge-danger" id="dot"><span id="dot-value"></span>
                          @endif
                          </span>                       </a>
                         <ul class="dropdown-menu mobileviewer-menu" id="view" style="min-width: 20rem;padding: 0.5rem 0.5rem;">
                                @if($unseen_notification->count() > 0)
                                        @foreach ($unseen_notification as $key => $notification)
                                            @php
                                                $check = 'done';
               ...
               <li class=" dropdown" id="mobile_inbox">
                   @php
                                    $unseen_chat_threads = chat_threads();
                                    $unseen_chat_thread_count = count($unseen_chat_threads);
                                    @endphp
                        <a>
                          <span class="mx-2"><i class="fa-solid fa-2x fa-envelope text-white"></i>@if($unseen_chat_thread_count > 0)
                          <span class="badge badge-danger" id="dot"><span id="dot-value"></span>
                          @endif</span>
                        <span class="caret"></span></a>
                         <ul class="dropdown-menu viewer-menu" id="mobile-inbox-view" style="min-width: 20rem;padding: 0.5rem 0.5rem;">
               ...
               <li class=" dropdown" id="mobileuser_id">
                           <a  type="button" data-toggle="dropdown" id="usermenu">
                          <b class="mx-2 font-italic d-sm-none d-lg-inline d-none">Hi {{Auth::user()->first_name}} !</b>
                          <img src="@if(Auth::user()->photo != "") {{ uploaded_asset(Auth::user()->photo) }} @else {{ static_asset('assets/img/avatar-place.png') }} @endif" id="user-icon">
                          <span class="caret"></span></a>
                       <ul class="dropdown-menu"  id="mobile-usermenu-nav" style>
                            <li class="nav-item user_text"><a class="nav-link" href=""><b class="mx-2 font-italic d-lg-none">Hi {{Auth::user()->first_name}} !</b></a> </li>
                          {{-- <li class="dropdown-submenu" id="test">
                            <a class=" nav-link test" href="#" ><span class="mx-2"> Account Setting</span> <span
                                class="caret"></span></a>
                          ...
                          <li class="nav-item"><a class="nav-link" href="{{ route('member.picture_privacy') }}"><span>Privacy Settings</span></a></li>
                          <li class="nav-item"><a class="nav-link" href="{{ route('member.change_password') }}"><span>Reset Password</span></a></li>
                          <li class="nav-item">
                            <a href="javascript:void(0);" class="nav-link" onclick="account_deactivation()">
                                @if(Auth::user()->deactivated == 0 )
                                    <span>{{ translate('Delete Account') }}</span>
                                @else
                                    <span>{{ translate('Enable Account') }}</span>
                                @endif
                            </a>
                        </li>
                          <!--<li class="nav-item"><a class="nav-link" href="#"><span class="mx-2">Help & Support</span></a></li>-->
                          <li class="nav-item"><a class="nav-link" href="{{ route('logout') }}"><span>Logout</span></a></li>
                        </ul>
                      </li>
