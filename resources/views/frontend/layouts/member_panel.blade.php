...
<style>
  ...
  @media only screen and (min-device-width:620px) and (max-device-width:720px) {
    .upload-button {
      margin-top: -7% !important;
      margin-left: 58% !important;
      position: absolute;
  ...
  @media only screen and (min-device-width:720px) and (max-device-width:820px) {
    .upload-button {
      margin-top: -7% !important;
  ...
  <div>
    ...
    <div class="dashboard-tabs-wrapper">
      <ul>
        ...
        <li class="dashboard-tab @if(request()->routeIs('view_contacts.index')) active @endif">
          <a href="{{ route('view_contacts.index') }}" class="dashboard-tab-link">
            <span class="dashboard-tab-icon"><i class="fa fa-phone-square"></i></span>
            {{ __('Contacts') }}
          </a>
        </li>
