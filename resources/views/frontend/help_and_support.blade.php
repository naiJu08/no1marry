  ...
  <div class="container">
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-sm-12 col-12">
          <div class="p-5">
            <h2 class="text-center font-weight-bold">Help and Support</h2>
            <h6 class="text-center info-head"><a href="userpage.html" class="text-black">Home</a> <span class="me-2">/</span><span class="ml-1">Help and Support</span></h6>
          </div>
     ...
     <div class="container">
                ...
                <div class="row justify-content-center">
                      <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                            <div class=" ">
                                <h6>when a user this Option admin must known about the user who clicked the option & for whom he clicked.</h6>
                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                          <div class=" ">
                            <ul>
                                <li>All option to be controlled by admin</li>
                                <li>Including report Option</li>
                            </ul>
