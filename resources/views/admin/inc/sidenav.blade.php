            ...
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('members.index', 3)}}" class="aiz-side-nav-link  {{ areActiveRoutes(['members.edit','members.show'])}}">
                                <span class="aiz-side-nav-text">{{translate('Standard Members')}}</span>
                            </a>
                        </li>
                        @endcan
                        ...
                        @endcan
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('marriage.support.admin')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Marriage Support List')}}</span>
                            </a>
                        </li>
