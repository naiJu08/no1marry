                ...
                <table class="table aiz-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th data-breakpoints="md">{{translate('ID Status')}}</th>
...
<script type="text/javascript">
    function sort_members(el){
     ...
     function package_info(id){
        ...
        $.post('/admin/members/package_info', {_token:'{{ @csrf_token() }}', id:id}, function(data){ 

        // $.post('https://no1marry.com/admin/members/package_info',{_token:'{{ @csrf_token() }}', id:id}, function(data){
            //  alert(data);
     ...
     function get_package(id){
            // $.post('https://no1marry.com/admin/members/get_package',{_token:'{{ @csrf_token() }}', id:id}, function(data){
        //  $.post('{{ route('members.get_package') }}',{_token:'{{ @csrf_token() }}', id:id}, function(data){
                $.post('/admin/members/get_package', {_token:'{{ @csrf_token() }}', id:id}, function(data){ 
             $('.create_edit_modal_content').html(data);
             $('.create_edit_modal').modal('show');
         });
     }
     ...
     function unblock_member(id){
        ...
        //  $.post('{{ route('members.blocking_reason') }}',{_token:'{{ @csrf_token() }}', id:id}, function(data){
          $.post('/admin/members/blocking_reason', {_token:'{{ @csrf_token() }}', id:id}, function(data){ 
