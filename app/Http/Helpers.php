...
if (!function_exists('static_asset')) {
    ...
    {
        // Remove accidental 'public/' in asset path
        $path = ltrim(str_replace('public/', '', $path), '/');

        // Use HTTPS in production
        $secure = $secure ?? app()->environment('production');

        // Return correct URL (no 'public/' prefix added)
        return $secure ? secure_asset($path) : asset($path);
    }
}
