...
class LanguageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($language->save()){
            ...
            toastr()->success(translate('Language has been inserted successfully'));
     ...
     */
     public function update(Request $request, $id)
     {
         ...
         $language->code = $request->code;
         if($language->save()){
             toastr()->success(translate('Language has been updated successfully'));
             return redirect()->route('languages.index');
         }
         else{
             toastr()->error(translate('Something went wrong'));
    ...
    public function update_rtl_status(Request $request)
    {
        ...
        if($language->save()){
            toastr()->success(translate('RTL status updated successfully'));
            return 1;
        }
        return 0;
    }
    ...
    public function changeLanguage(Request $request)
    {
        ...
        toastr()->success(translate('Language changed to ').$language->name);
    }
    ...
    public function destroy($id)
    {
        if (Language::destroy($id)) {
            toastr()->success(translate('Language has been deleted successfully'));
            return redirect()->route('languages.index');
        } else {
            toastr()->error(translate('Something went wrong'));
            return back();
