...
class CurrencyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($currency->save())
        {
            toastr()->success(translate('New Currency has been added successfully'));
    ...
    public function update(Request $request, $id)
    {
        ...
        if($currency->save())
        {
            toastr()->success(translate('Currency info has been updated successfully'));
            return back();
        }
        else {
            toastr()->error(translate('Sorry! Something went wrong.'));
    ...
    public function destroy($id)
    {
        ...
        {
            toastr()->success(translate('Currency info has been deleted successfully'));
            return back();
        }
        else {
            toastr()->error(translate('Sorry! Something went wrong.'));
