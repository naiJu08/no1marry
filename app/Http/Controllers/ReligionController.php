...
class ReligionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($religion->save()){
            toastr()->success(translate('New religion has been added successfully'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $religion->name = $request->name;
        if($religion->save()){
            toastr()->success(translate('Religion info has been updated successfully'));
            return redirect()->route('religions.index');
        } else {
            toastr()->error(translate('Sorry! Something went wrong.'));
            return back();
    ...
    public function destroy($id)
    {
        ...
        if (Religion::destroy($id)) {
            toastr()->success(translate('Religion info has been deleted successfully'));
            return redirect()->route('religions.index');
        } else {
            toastr()->error(translate('Sorry! Something went wrong.'));
            return back();
