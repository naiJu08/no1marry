...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        toastr()->success(translate('New Role has been added successfully'));
        return redirect()->route('roles.index');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $role->save();
        toastr()->success(translate('Role has been updated successfully'));
        return back();
    }
    ...
    {
        if(Role::destroy($id)){
            toastr()->success(translate('Role has been deleted successfully'));
            return redirect()->route('roles.index');
        }
        else{
