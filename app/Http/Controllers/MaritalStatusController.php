...
class MaritalStatusController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        {
            toastr()->success('New Marital Status has been added successfully');
    ...
    public function update(Request $request, $id)
    {
        ...
        if($marital_status->save())
        {
            toastr()->success('Marital Status has been updated successfully');
            return redirect()->route('marital-statuses.index');
        }
        else {
            toastr()->error('Sorry! Something went wrong.');
    ...
    public function destroy($id)
    {
        if (MaritalStatus::destroy($id)) {
            toastr()->success('Marital Status info has been deleted successfully');
            return redirect()->route('marital-statuses.index');
        } else {
            toastr()->error('Sorry! Something went wrong.');
            return back();
