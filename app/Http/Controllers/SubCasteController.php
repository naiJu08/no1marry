...
class SubCasteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($sub_caste->save())
        {
            toastr()->success(translate('New Sub Caste has been added successfully'));
    ...
    public function update(Request $request, $id)
    {
        ...
        if($sub_caste->save())
        {
            toastr()->success(translate('Sub Caste info has been updated successfully'));
            return redirect()->route('sub-castes.index');
        }
        else {
            toastr()->error(translate('Sorry! Something went wrong.'));
    ...
    public function destroy($id)
    {
        ...
        if (SubCaste::destroy($id)) {
            toastr()->success(translate('Sub Caste info has been deleted successfully'));
            return redirect()->route('sub-castes.index');
        } else {
            toastr()->error(translate('Sorry! Something went wrong.'));
            return back();
