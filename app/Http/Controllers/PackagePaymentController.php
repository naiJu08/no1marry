...
class PackagePaymentController extends Controller
{
    ...
    // {
    //     $per_page            = 10;
    //     $package_payments    = ProfilePayment::latest()->paginate($per_page);
    ...
    public function store(Request $request)
    {
        ...
        elseif ($request->payment_option == 'payu') {
            $payu = new PayUMoneyController;
            return $payu->pay($request);
        }
        ...
        elseif ($request->payment_option == 'wallet') {
            if(Auth::user()->balance < $request->amount){
                toastr()->error(translate('You do not have enough balance.'));
                return back();
            }
            else {
    ...
    public function manual_payment_accept($id)
    {
      ...
      toastr()->success(translate('Payemnt accepted successfully.'));
      return back();
    }
