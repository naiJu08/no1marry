...
class StateController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($state->save())
        {
            toastr()->success(translate('New state has been added successfully'));
    ...
    public function update(Request $request, $id)
    {
        ...
        if($state->save())
        {
            toastr()->success(translate('State info has been updated successfully'));
            return redirect()->route('states.index');
        }
        else {
            toastr()->error(translate('Sorry! Something went wrong.'));
    ...
    public function destroy($id)
    {
        ...
        if (State::destroy($id)) {
            toastr()->success(translate('State info has been deleted successfully'));
            return redirect()->route('states.index');
        } else {
            toastr()->error(translate('Sorry! Something went wrong.'));
            return back();
