...
class CasteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($caste->save())
        {
            toastr()->success('New caste has been added successfully');
    ...
    public function update(Request $request, $id)
    {
        ...
        if($caste->save())
        {
            toastr()->success('Caste info has been updated successfully');
            return redirect()->route('castes.index');
        }
        else {
            toastr()->error('Sorry! Something went wrong.');
    ...
    public function destroy($id)
    {
        ...
        if (Caste::destroy($id)) {
            toastr()->success('Caste info has been deleted successfully');
            return redirect()->route('castes.index');
        } else {
            toastr()->error('Sorry! Something went wrong.');
            return back();
