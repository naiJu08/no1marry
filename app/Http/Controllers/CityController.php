...
class CityController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($city->save())
        {
            toastr()->success(translate('New City has been added successfully'));
    ...
    public function update(Request $request, $id)
    {
        ...
        if($city->save())
        {
            toastr()->success(translate('City info has been updated successfully'));
            return redirect()->route('cities.index');
        }
        else {
            toastr()->error(translate('Sorry! Something went wrong.'));
    ...
    {
        if (City::destroy($id)) {
            toastr()->success(translate('City info has been deleted successfully'));
            return redirect()->route('cities.index');
        } else {
            toastr()->error(translate('Sorry! Something went wrong.'));
            return back();
