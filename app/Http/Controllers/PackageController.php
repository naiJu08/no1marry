...
class PackageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($package->save()){
            toastr()->success(translate('New Package has been added successfully'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $package->image             = $request->package_image;
        if($package->save()){
            toastr()->success(translate('Package info has been updated successfully'));
            return redirect()->route('packages.index');
        } else {
            toastr()->error(translate('Sorry! Something went wrong.'));
            return back();
    ...
    public function destroy($id)
    {
        if(Package::destroy($id)){
            toastr()->success(translate('Package info has been deleted successfully'));
            return redirect()->route('packages.index');
        }
        else {
            toastr()->error(translate('Sorry! Something went wrong.'));
