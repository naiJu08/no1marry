...
class StaffController extends Controller
{
        ...
        if(User::where('email', $request->email)->first() == null){
            ...
            if($user->save()){
                ...
                if($staff->save()){
                    ...
                    toastr()->success(translate('Staff has been inserted successfully'));
                    return redirect()->route('staffs.index');
                }
            }
        }

        toastr()->error(translate('Email already used'));
        return back();
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($user->save()){
            ...
            $user->assignRole(Role::findOrFail($request->role_id)->name);
            if($staff->save()){
                toastr()->success(translate('Staff has been updated successfully'));
                return redirect()->route('staffs.index');
            }
        }
    ...
    public function destroy($id)
    {
        ...
        if(Staff::destroy($id)){
            toastr()->success(translate('Staff has been deleted successfully'));
            return redirect()->route('staffs.index');
        }
